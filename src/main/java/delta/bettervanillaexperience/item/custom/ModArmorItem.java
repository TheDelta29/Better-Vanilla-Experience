package delta.bettervanillaexperience.item.custom;

import com.google.common.collect.ImmutableMap;
import delta.bettervanillaexperience.item.ModArmorMaterials;
    ...
    private static final Map<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<RegistryEntry<ArmorMaterial>, List<StatusEffectInstance>>())
                    .put(ModArmorMaterials.PINK_GARNET_ARMOR_MATERIAL,
                            List.of(new StatusEffectInstance(StatusEffects.REGENERATION, 400, 0, false, false)))
                    // To add effects to an armor set of a different material
                    //.put(ModArmorMaterials.PINK_GARNET_ARMOR_MATERIAL, <- to replace with the different material
                            //List.of(new StatusEffectInstance(StatusEffects.REGENERATION, 400, 1, false, false)))
                    .build();
