...
public class ModLootTableProvider extends FabricBlockLootTableProvider {
    ...
    public void generate() {
        ...
        addDrop(ModBlocks.ENDISITE_BLOCK);
        addDrop(ModBlocks.RAW_ENDISITE_BLOCK);
        addDrop(ModBlocks.END_JADE_BLOCK);


        // Ores that drop one item
        addDrop(ModBlocks.PINK_GARNET_ORE, oreDrops(ModBlocks.PINK_GARNET_ORE, ModItems.RAW_PINK_GARNET));
        addDrop(ModBlocks.ENDISITE_ORE_BLOCK, oreDrops(ModBlocks.ENDISITE_ORE_BLOCK, ModItems.RAW_ENDISITE));
        addDrop(ModBlocks.END_JADE_ORE_BLOCK, oreDrops(ModBlocks.END_JADE_BLOCK, ModItems.END_JADE));


        // Ores that drop multiple items
